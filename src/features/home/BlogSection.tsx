...
const newsItems = [
  {
    ...
    excerpt: "Thông báo tuyển sinh du học Hàn Quốc các hệ D4-1, D2-1... với nhiều ưu đãi hấp dẫn.",
  },
  {
    id: 2,
    ...
    excerpt: "Chia sẻ những bí quyết quan trọng giúp bạn tự tin trong buổi phỏng vấn cùng Lãnh sự quán.",
  },
  {
    id: 3,
    ...
    excerpt: "Cơ hội nhận học bổng 100% học phí và sinh hoạt phí từ các trường đại học hàng đầu Trung Quốc.",
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {newsItems.map((item) => (
            ...
            >
              <Link href={`/tin-tuc/${item.id}`} className="block relative h-60 overflow-hidden">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
