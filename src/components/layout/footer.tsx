  ...
  return (
    <footer className="bg-[#1c2559] text-white pt-16 pb-8 font-sans">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-300 mt-2">
            Mang đến cơ hội học tập và làm việc tại Hàn Quốc cho hàng ngàn học
            sinh Việt Nam.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-gray-300">
            ...
            <li className="flex gap-2 items-center">
              ...
              <span>contact@hcm-mirai.vn</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-700 mt-12 pt-8 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} HCM-MIRAI. All rights reserved.
      </div>
    </footer>
  );
}
